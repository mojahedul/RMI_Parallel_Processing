...
public class Server_Interface_Implementation extends UnicastRemoteObject implements Server_Interface
{
		...
		throws java.rmi.RemoteException
	{
		...
		if( (!client_List.contains(obj_ClientInterface)) )
		{
			...
			do_Callbacks();
			export_Value_To_Sum(obj_ClientInterface);
	...
	private synchronized void export_Value_To_Sum(Client_Interface obj_ClientInterface)
	throws java.rmi.RemoteException
	{
		int sum = obj_ClientInterface.adder(10, 5);

		System.out.println("RMI Sum = " + sum);
	}
